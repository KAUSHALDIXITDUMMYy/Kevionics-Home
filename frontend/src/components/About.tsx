        ...
        <div className="about__visual">
          ...
          <div className="about__circuit" aria-hidden="true">
            <svg viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <circle cx="20" cy="60" r="3" fill="var(--blue-accent)" opacity="0.85" />
              <circle cx="60" cy="60" r="3" fill="var(--blue-bright)" opacity="0.75" />
              <circle cx="60" cy="30" r="3" fill="var(--blue-accent)" opacity="0.85" />
              <circle cx="120" cy="30" r="3" fill="var(--blue-bright)" opacity="0.75" />
              <circle cx="120" cy="90" r="3" fill="var(--blue-accent)" opacity="0.85" />
              <circle cx="60" cy="90" r="3" fill="var(--blue-bright)" opacity="0.75" />
            </svg>
          </div>
        </div>
      </div>
